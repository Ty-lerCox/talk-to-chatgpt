...
function CN_SayOutLoud(text, trackId) {
    console.log(text, trackId);
    ...
    var params = {
        OutputFormat: 'mp3',
        Text: text,
        VoiceId: 'Joanna', // Joanna, Matthew, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Brian, Geraint, Matthew, Ivy, Joanna, Joey, Justin, Kendra, Kimberly, Salli, Kendra, Kimberly, Salli
    };
...
function CN_SpeakAllTracks() {
    if (tracks.length == 0) {
		activeTrackId = 0;
		tracks = [];
        CN_AfterSpeakOutLoudFinished();
		console.log('No tracks to speak');
        return;
    }
    ...
    console.log('Active TrackID: ', activeTrackId);
    var track = null;
	var trackId = null;
    for (var i = 0; i < tracks.length; i++) {
        if (tracks[i].trackId == activeTrackId) {
            track = tracks[i];
			trackId = i;
            break;
        }
    ...
    if (track == null) {
		console.log('Track not found', activeTrackId, tracks, tracks.length, tracks[0], tracks[0].trackId);
        return;
    }

    isSpeaking = true;
    console.log('Track: ', track, 'ID: ', activeTrackId);
    var audioElement = new Audio();
    audioElement.src = URL.createObjectURL(track.blob);
    audioElement.play();
...
function CN_StartSpeechRecognition() {
    ...
    CN_SPEECHREC.onresult = (event) => {
        ...
        if (final_transcript.toLowerCase() == CN_SAY_THIS_WORD_TO_STOP) {
            ...
            final_transcript.toLowerCase() == CN_SAY_THIS_WORD_TO_PAUSE
        ) {
            console.log(
                "You said '" +
